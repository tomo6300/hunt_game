...
class BeastPage extends StatefulWidget {
  BeastPage({Key? key}) : super(key: key);

  @override
  State<BeastPage> createState() => _BeastPageState();
}

class _BeastPageState extends State<BeastPage> {
  final int moveCost = 1;

  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  final List<int> _items = List.generate(22, (i) => i);
  int _selectedSquareForBeast = 0;
  String event = "";

  BeastState beastState = BeastState([0], [-1, -1, -1], 20);
